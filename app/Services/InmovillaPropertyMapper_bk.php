...
private $propertyTypesMapping = [
    ...
    2899 => 'Ático',          // Ático ✅
    // Ático Dúplex probablemente use el mismo código 2899 o verificaremos
    
    // CASAS (Villas): Villa, villa de lujo y chalet
    4999 => 'Casa',           // Villa ✅
    5099 => 'Casa',           // Villa de Lujo (código a confirmar) ✅
    499  => 'Casa',           // Chalet ✅
    399  => 'Casa',           // Casa ✅
    299  => 'Casa',           // Bungalow
    599  => 'Casa',           // Cortijo
    ...
    // Comerciales (mapear a Apartamento por defecto)
    1299 => 'Apartamento',    // Local comercial
    1399 => 'Apartamento',    // Oficina
    2399 => 'Apartamento',    // Garaje
    2599 => 'Apartamento',    // Parking
    2699 => 'Apartamento',    // Trastero
