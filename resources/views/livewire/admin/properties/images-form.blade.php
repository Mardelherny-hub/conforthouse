        ...
        <div>
            <div class="flex items-center mb-3">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 01-4.559-4.559l-.477-2.387a2 2 0 00-.547-1.022L6 5m14 0l-4-4m4 4l-4 4m-4 4H5a2 2 0 01-2-2V7a2 2 0 012-2h4a2 2 0 012 2v4a2 2 0 01-2 2H5" />
                </svg>
                    ...
                    @foreach($existingImages as $image)
                        <div class="relative group">
                            ...
                            >
                                ...
                                <span wire:loading wire:target="removeExistingImage({{ $image->id }})" class="flex items-center">
            ...
            @if(!empty($tempPhotos))
                <div class="grid grid-cols-4 md:grid-cols-6 gap-3 mt-4">
                    @foreach($tempPhotos as $index => $photo)
                        <div class="relative group">
                            <img
                                src="{{ $photo['original']->temporaryUrl() }}"
                                class="w-full aspect-square object-cover rounded-lg shadow-md"
                            >
                            <button
