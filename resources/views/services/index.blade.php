        ...
        <div class="container mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                ...
                <div class="group bg-white border border-gray-200 hover:border-amber-300 p-8 rounded-sm transition-all duration-300 hover:shadow-lg flex flex-col">
                    ...
                    <a href="{{ route('prop.index', ['locale' => app()->getLocale(), 'operation_id' => 1]) }}" class="inline-flex items-center text-amber-600 font-luxury-sans group-hover:text-amber-700">
                ...
                <div class="group bg-white border border-gray-200 hover:border-amber-300 p-8 rounded-sm transition-all duration-300 hover:shadow-lg flex flex-col">
                    ...
                    <a href="{{ route('prop.index', ['locale' => app()->getLocale(), 'operation_id' => 2]) }}" class="inline-flex items-center text-amber-600 font-luxury-sans group-hover:text-amber-700">
                        <span>{{ __('messages.learn_more') }}</span>
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-2 transform group-hover:translate-x-1 transition-transform duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3" />
                        </svg>
                ...
                <!-- Servicio 4: Tasación de Propiedades -->
                <div class="group bg-white border border-gray-200 hover:border-amber-300 p-8 rounded-sm transition-all duration-300 hover:shadow-lg flex flex-col">
                    <div class="mb-6 text-amber-400">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white p-8 border border-gray-200 rounded-sm shadow-sm">
                    ...
                    <div class="flex items-center">
                        <img src="{{ asset('assets/images/testimonials/client1.jpg') }}" alt="Cliente" class="w-12 h-12 rounded-full object-cover mr-4">
                        <div>
                ...
                <div class="bg-white p-8 border border-gray-200 rounded-sm shadow-sm">
                    ...
                    <div class="flex items-center">
                        <img src="{{ asset('assets/images/testimonials/client2.jpg') }}" alt="Cliente" class="w-12 h-12 rounded-full object-cover mr-4">
                        <div>
                ...
                <div class="bg-white p-8 border border-gray-200 rounded-sm shadow-sm">
                    ...
                    <div class="flex items-center">
                        <img src="{{ asset('assets/images/testimonials/client3.jpg') }}" alt="Cliente" class="w-12 h-12 rounded-full object-cover mr-4">
                        <div>
